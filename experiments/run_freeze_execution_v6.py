"""Build and verify the EXECUTION freeze v4 (P1.2-B). Supersedes freeze v5.

Covers all src, all v2 runners + execution contract + custody + evaluators, tests,
prereg v6 (json+md) + execution contract v4, the audits and changelogs, DECISIONS,
...
CONFIG_REL = "experiments/configs/synthetic_prereg_v6.json"
PDF_REL = "docs/research/sources/eser2025_arxiv_2507.08007v2.pdf"
OUT = "artifacts/freeze_execution_v6.json"
...
def main() -> None:
    ...
    print(f"execution freeze v6 written: {manifest['n_files']} files -> {out}")
    print(f"prereg v6 canonical : {manifest['config_canonical_hash']}")
