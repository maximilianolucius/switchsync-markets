"""Build and verify the EXECUTION freeze v4 (P1.2-B). Supersedes freeze v3.

Covers all src, all v2 runners + execution contract + custody + evaluators, tests,
prereg v4 (json+md) + execution contract v2, the audits and changelogs, DECISIONS,
...
CONFIG_REL = "experiments/configs/synthetic_prereg_v4.json"
PDF_REL = "docs/research/sources/eser2025_arxiv_2507.08007v2.pdf"
OUT = "artifacts/freeze_execution_v4.json"
...
def main() -> None:
    ...
    print(f"execution freeze v4 written: {manifest['n_files']} files -> {out}")
    print(f"prereg v4 canonical : {manifest['config_canonical_hash']}")
