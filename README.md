...
> - **Pre-execution status (P1.2-E):** the authoritative harness is prereg v7 + execution contract v5 + execution freeze v7 (`switchsync-synthetic-execution-v7-freeze`); freezes v3/v4/v5/v6 were each found non-executable and superseded. No v2–v7 scientific result exists; nothing was executed.
