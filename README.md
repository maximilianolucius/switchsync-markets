...
> - **Pre-execution status (P1.2-D):** the authoritative harness is prereg v6 + execution contract v4 + execution freeze v6 (`switchsync-synthetic-execution-v6-freeze`); freezes v3/v4/v5 were each found non-executable and superseded. No v2–v6 scientific result exists; nothing was executed.
