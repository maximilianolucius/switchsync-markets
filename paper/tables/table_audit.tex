% Audit / reproducibility identifiers (Appendix A). All values verified by a
% separate post-execution artifact audit of the sealed attempt.
\begin{table}[h]
\centering
...
separate pre-execution artifact audits and were \emph{never run}; no result predates
the attempt below.}
\label{tab:audit}
\resizebox{\linewidth}{!}{%
\begin{tabular}{@{}ll@{}}
